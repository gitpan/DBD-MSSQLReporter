NAME
    DBD::MSSQLReporter - An module to connect Perl to MS SQL Server and MS
    Data Engine
...
DESCRIPTION
    `DBD::MSSQLReporter' encapsulates the connection between Perl and MS SQL
    Server.

    `DBD::MSSQLReporter' was written so that I could teach myself about MS
...
INSTALLATION
    You install `DBD::MSSQLReporter', as you would install any perl module,
...
AUTHOR
    `DBD::MSSQLReporter' was written by Ron Savage *<ron@savage.net.au>* in
    2000.
